...
This sketch (software) has been developed specifically for the **devices listed** and the **specified* CAN transceiver module. It has only been tested on the author’s personal model railway layout.
