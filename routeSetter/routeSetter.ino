     ...
     const char configDefInfo[] PROGMEM =
       ...
       CDIheader R"(
         ...
         <group>
            ...
            <hints><visibility hideable='yes' hidden='yes' ></visibility></hints>     
            <description>Possible choices 0-1000ms in 100ms steps</description>
            <int size='1'><name>Choose one value and click write</name>
              <map>
...
void userConfigWritten(uint32_t address, uint16_t length, uint16_t func) {
  ...
  // recalculate turnputDelay in case it changed.
